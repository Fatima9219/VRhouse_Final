...
namespace Valve.VR.InteractionSystem  // aus dem namespace raus?
{    //-------------------------------------------------------------------------
    public class Interactable_pickingcart : MonoBehaviour
    {
        ...
        protected virtual void OnAttachedToHand(Hand hand)
        {
            ...
            if (skeletonPoser != null && hand.skeleton != null)
            {
                ...
                // !!!! -------------------------------
                LogicStatusRegister.pickerCartGrabbed = true;
            }
        ...
        protected virtual void OnDetachedFromHand(Hand hand)
        {
            ...
            if (skeletonPoser != null)
            {
                ...
                // !!!! -------------------------------
                LogicStatusRegister.pickerCartGrabbed = false;
            }
